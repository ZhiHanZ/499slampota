#ifndef CPP_SERVICE_LAYER_INTERFACE_H_
#define CPP_SERVICE_LAYER_INTERFACE_H_
...
class ServiceLayerInterface {
	public:
		...
		virtual std::string RegisterUser(const std::string& username) = 0;
		...
		virtual std::vector<chirp::Chirp> Read(const std::string& chirp_id) = 0;
...
#endif /*CPP_SERVICE_LAYER_INTERFACE_H*/