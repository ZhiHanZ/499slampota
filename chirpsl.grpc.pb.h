...
#ifndef GRPC_chirpsl_2eproto__INCLUDED
#define GRPC_chirpsl_2eproto__INCLUDED
...
class ServiceLayer final {
 public:
  ...
  typedef WithAsyncMethod_registeruser<WithAsyncMethod_chirp<WithAsyncMethod_follow<WithAsyncMethod_read<WithAsyncMethod_monitor<Service > > > > > AsyncService;
  template <class BaseClass>
  ...
  typedef ExperimentalWithCallbackMethod_registeruser<ExperimentalWithCallbackMethod_chirp<ExperimentalWithCallbackMethod_follow<ExperimentalWithCallbackMethod_read<ExperimentalWithCallbackMethod_monitor<Service > > > > > ExperimentalCallbackService;
  template <class BaseClass>
  ...
  typedef WithStreamedUnaryMethod_registeruser<WithStreamedUnaryMethod_chirp<WithStreamedUnaryMethod_follow<WithStreamedUnaryMethod_read<WithSplitStreamingMethod_monitor<Service > > > > > StreamedService;
};

}  // namespace chirp


#endif  // GRPC_chirpsl_2eproto__INCLUDED
