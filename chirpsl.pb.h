...
#ifndef PROTOBUF_INCLUDED_chirpsl_2eproto
#define PROTOBUF_INCLUDED_chirpsl_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_chirpsl_2eproto 
...
class Timestamp : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:chirp.Timestamp) */ {
 ...
 private:
  ...
  friend struct ::protobuf_chirpsl_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#endif  // PROTOBUF_INCLUDED_chirpsl_2eproto
